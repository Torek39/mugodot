...
@onready var load_menu_scene = preload("res://scenes/load_menu.tscn")
...
func _on_play():
	...
	Global.bridge_repaired = false
	Global.wall_detonated = false
	Global.guardian_chest_opened = false
	Global.teleport_activated = false
	Global.glitch_fixed = false
	Global.book_pages = []
